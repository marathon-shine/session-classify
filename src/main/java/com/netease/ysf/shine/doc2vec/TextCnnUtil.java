...
public class TextCnnUtil {
    ...
    public static void trainAndTest() {
        ...
        WordVectors wordVectors = WordVectorSerializer.loadStaticModel(
                new File(Constants.fileBase + "word2VecModel.bin")
        );
    ...
    private static DataSetIterator getDataSetIterator(WordVectors wordVectors, int minibatchSize, int maxSentenceLength){
        String corpusPath = Constants.fileBase + "parsed_all_session.withtype.txt.training.notype.txt";
        String labelPath = Constants.fileBase + "parsed_all_session.withtype.txt.training.label.txt";
